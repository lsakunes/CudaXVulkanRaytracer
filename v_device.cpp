...
void V_Device::pickPhysicalDevice() {
...
void V_Device::createSurface() { window.createWindowSurface(instance, &surface_); }
...
void V_Device::createBuffer(
    ...
    bufferInfo.sharingMode = VK_SHARING_MODE_EXCLUSIVE; // TODO: examine for shared buffers
